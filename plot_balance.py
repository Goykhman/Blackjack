...
fig=plt.figure(figsize=(8,5))
plt.hist(data,bins=50)
plt.xlabel("probability of loosing double down")
plt.ylabel("count")
mn,std=data.mean(),data.std()
mn=int(100*mn)/100.0
std=int(100*std)/100.0
plt.title("Probability of loosing double down in basic strategy, mean={}, std={}".format(mn,std))
plt.show()
...
fig=plt.figure(figsize=(8,5))
plt.hist(data,bins=50)
plt.xlabel("probability of loosing a split")
plt.ylabel("count")
mn,std=data.mean(),data.std()
mn=int(100*mn)/100.0
std=int(100*std)/100.0
plt.title("Probability of loosing split in basic strategy, mean={}, std={}".format(mn,std))
plt.show()
